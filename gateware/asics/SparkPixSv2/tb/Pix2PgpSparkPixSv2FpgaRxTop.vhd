...
entity Pix2PgpSparkPixSv2FpgaRxTop is
   generic(
      TPD_G                  : time      := 1 ns;
   ...
   port (
      ...
      sro             : in  std_logic;
      -- Aggregated eroOut from ColumnModels; unused by SparkPix-Sv2 (non-ERO
      -- ASIC), exposed for interface uniformity with ERO variants.
      ero             : in  std_logic := '0';
      daq             : in  std_logic;
...
end entity Pix2PgpSparkPixSv2FpgaRxTop;

architecture behav of Pix2PgpSparkPixSv2FpgaRxTop is
