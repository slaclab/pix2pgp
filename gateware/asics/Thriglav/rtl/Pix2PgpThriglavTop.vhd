...
begin
   ...
   assert (ASIC_DATABUS_DWIDTH_C = 32)
      report "[ERROR]: Pix2PgpThriglavTop; ASIC_DATABUS_DWIDTH_C is *NOT* equal to 32! Please check that Pix2PgpPkg.vhd matches Pix2PgpSparkPixSPkg.vhd" severity failure;
