...
-------------------------------------------------------------------------------
-- Description: Pix2Pgp ASIC Stream Receiver - Version 2.0;
...
entity Pix2PgpAsicStreamRxV2 is
   generic(
      TPD_G                  : time     := 1 ns;
...
end Pix2PgpAsicStreamRxV2;

architecture rtl of Pix2PgpAsicStreamRxV2 is
