...
-------------------------------------------------------------------------------
-- Description: Wrapper for cascading FWFT FIFOs together (based on surf)
-------------------------------------------------------------------------------
...
entity Pix2PgpFifoCascade is
   ...
   port (
      ...
      almost_empty  : out sl;
      empty         : out sl);
end Pix2PgpFifoCascade;

architecture mapping of Pix2PgpFifoCascade is
...
begin
   ...
   ONE_STAGE : if (CASCADE_SIZE_G = 1) generate
      ...
      Fifo_1xStage : entity pix2pgp.Pix2PgpFifo
         generic map (
            TPD_G           => TPD_G,
   ...
   TWO_STAGE : if (CASCADE_SIZE_G >= 2) generate
      ...
      Fifo_First_Stage : entity pix2pgp.Pix2PgpFifo
         generic map (
            TPD_G           => TPD_G,
            RST_POLARITY_G  => RST_POLARITY_G,
            RST_ASYNC_G     => RST_ASYNC_G,
      ...
      MULTI_STAGE : if (CASCADE_SIZE_G > 2) generate
         ...
         for i in (CASCADE_SIZE_G-2) downto 1 generate
            ...
            Fifo_Middle_Stage : entity pix2pgp.Pix2PgpFifo
               generic map (
                  TPD_G           => TPD_G,
                  RST_POLARITY_G  => RST_POLARITY_G,
                  RST_ASYNC_G     => RST_ASYNC_G,
      ...
      Fifo_Last_Stage : entity pix2pgp.Pix2PgpFifo
         generic map (
            TPD_G           => TPD_G,
            RST_POLARITY_G  => RST_POLARITY_G,
            RST_ASYNC_G     => RST_ASYNC_G,
