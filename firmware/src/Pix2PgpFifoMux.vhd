...
-------------------------------------------------------------------------------
-- Description: Resizing FIFO module (based on the surf module)
-------------------------------------------------------------------------------
...
architecture rtl of Pix2PgpFifoMux is
...
begin
   ...
   -- Fifo
   --------
   FifoCascade_Inst : entity pix2pgp.Pix2PgpFifoCascade
      generic map (
         TPD_G              => TPD_G,
