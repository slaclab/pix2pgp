...
entity Pix2PgpSparkPixTEmuTb is
   generic(
      TPD_G                     : time     := 1 ns;
...
end entity Pix2PgpSparkPixTEmuTb;

architecture test of Pix2PgpSparkPixTEmuTb is
   ...
   -- UUT
   ------
   U_Uut : entity pix2pgp.Pix2PgpSparkPixTTopTb
      generic map(
         TPD_G                     => TPD_G,
