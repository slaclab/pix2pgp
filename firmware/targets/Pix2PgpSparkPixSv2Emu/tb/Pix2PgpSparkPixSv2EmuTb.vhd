...
entity Pix2PgpSparkPixSv2EmuTb is
   generic(
      TPD_G                     : time     := 1 ns;
...
end entity Pix2PgpSparkPixSv2EmuTb;

architecture test of Pix2PgpSparkPixSv2EmuTb is
   ...
   -- UUT
   ------
   U_Uut : entity pix2pgp.Pix2PgpSparkPixSv2TopTb
      generic map(
         TPD_G                     => TPD_G,
